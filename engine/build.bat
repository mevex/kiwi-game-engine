...
set Libraries=user32.lib %VULKAN_SDK%\Lib\vulkan-1.lib

set CompilerFlags=/nologo /MDd /fp:fast /GR- /EHa- /Od /Oi /WX /W4 /FC /Zi /LD %IncludeFolders% %Defines% %IgnoredWarnings%
